          ...
          <Table className="border-collapse">
            <TableHeader>
              <TableRow className="bg-slate-50 hover:bg-slate-50 border-b">
                ...
                <TableHead className="w-20 text-center font-semibold text-orange-700 text-xs">Total</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {groupByDriver ? (
          ...
          <Table className="border-t-2 border-slate-300">
            <TableBody>
              <TableRow className="bg-orange-50 hover:bg-orange-50 border-b font-semibold">
                ...
                <TableCell className="text-center">
                  <div className="inline-flex items-center justify-center px-2 py-1 text-xs font-bold text-orange-800 bg-orange-200 rounded">
