...
exports.parseBagFormat = parseBagFormat;
exports.formatBagDisplay = formatBagDisplay;
exports.calculateNEAEndTime = calculateNEAEndTime;
function parseBagFormat(bagFormat) {
    try {
...
function formatBagDisplay(nonVegCount, vegCount) {
    if (vegCount === 0) {
        return nonVegCount.toString();
    }
    return `${nonVegCount}+${vegCount}`;
}
function calculateNEAEndTime(startTime, durationHours = 4) {
    const endTime = new Date(startTime);
    endTime.setHours(endTime.getHours() + durationHours);
    return endTime;
}
//# sourceMappingURL=bagFormatParser.js.map